    ...
    public class PolicyMapperProfile : Profile
    {
        public PolicyMapperProfile()
        {
            CreateMap<Policys, ViewPolicyListDto>()
                ...
                //.ForMember(des => des.FaceAmount, mo => mo.MapFrom(src => src.FaceAmount))
                .ForMember(des => des.Payment, mo => mo.MapFrom(src => src.Amount))
                ...
                //.ForMember(des => des.Rating, mo => mo.MapFrom(src => src.Rating))
